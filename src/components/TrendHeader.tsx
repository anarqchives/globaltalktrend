          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {user ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="min-w-[180px] z-50 bg-popover/95 backdrop-blur-xl border border-border/50 shadow-lg rounded-xl p-1 animate-scale-in origin-top-right">
                  <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, ease: "easeOut" }}>
                    <DropdownMenuItem onClick={handleLoginGoogle} className="text-xs gap-2 cursor-pointer rounded-lg px-2.5 py-2 font-medium hover:bg-accent/80 transition-colors">
                  ...
                  <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2, delay: 0.06, ease: "easeOut" }}>
                    <DropdownMenuItem onClick={handleLoginApple} className="text-xs gap-2 cursor-pointer rounded-lg px-2.5 py-2 font-medium hover:bg-accent/80 transition-colors">
