  ...
  useEffect(() => {
    const run = async () => {
      try {
        setLoading(true);
        setError(null);
        console.log("🔍 [ROTA TESTE] Buscando somente The Guardian...");
        ...
        console.log("✅ [ROTA TESTE] The Guardian retornou:", guardianOnly.length, "itens");
        setItems(guardianOnly);
      } catch (e: any) {
        console.error("❌ [ROTA TESTE] Erro no carregamento do The Guardian:", e);
