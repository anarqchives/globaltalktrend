  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        critical: { DEFAULT: 'hsl(var(--color-critical))', bg: 'hsl(var(--color-critical-bg))' },
        positive: { DEFAULT: 'hsl(var(--color-positive))', bg: 'hsl(var(--color-positive-bg))' },
        chart: {
          '1': 'hsl(var(--chart-1))', '2': 'hsl(var(--chart-2))', '3': 'hsl(var(--chart-3))',
          '4': 'hsl(var(--chart-4))', '5': 'hsl(var(--chart-5))', '6': 'hsl(var(--chart-6))',
        },
        warning: { bg: 'hsl(var(--warning-bg))', fg: 'hsl(var(--warning-fg))' },
        success: { bg: 'hsl(var(--success-bg))', fg: 'hsl(var(--success-fg))' },
        info: { bg: 'hsl(var(--info-bg))', fg: 'hsl(var(--info-fg))' },
      },
      spacing: {
        'sp-0': 'var(--space-0)', 'sp-1': 'var(--space-1)', 'sp-2': 'var(--space-2)',
        'sp-3': 'var(--space-3)', 'sp-4': 'var(--space-4)', 'sp-5': 'var(--space-5)',
        'sp-6': 'var(--space-6)', 'sp-8': 'var(--space-8)', 'sp-10': 'var(--space-10)',
        'sp-12': 'var(--space-12)', 'sp-16': 'var(--space-16)',
      },
      borderRadius: {
        lg: 'var(--radius)',
